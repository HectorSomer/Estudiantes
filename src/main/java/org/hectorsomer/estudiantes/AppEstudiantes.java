package org.hectorsomer.estudiantes;
...
public class AppEstudiantes extends javafx.application.Application {
    private static Stage stageView;
    private static Stage stageRoot;
    private static Universities universities=new Universities();

    public static Universities getUniversities() {
        return universities;
    }
    @Override
    public void start(Stage stage) throws IOException {
        stageRoot = stage;
        FXMLLoader fxmlLoader = new FXMLLoader(AppEstudiantes.class.getResource("home-view.fxml"));
    ...
    private static Parent loadFXML(String fxml) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(AppEstudiantes.class.getResource(fxml + ".fxml"));
