...
public class ViewStudentsUpController {
    ...
    @FXML
    private TableView<Student> tableStudentsUp;
    ...
    void initialize() {
        ...
        estudiantes= AppEstudiantes.getUniversities().showStudentsUp();
        ...
        tableStudentsUp.setItems(studentsList);
    }
}
